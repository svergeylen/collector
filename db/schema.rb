...
ActiveRecord::Schema.define(version: 20171006090407) do

  # Ancien ite BD
  create_table "bd_auteurs", primary_key: "aid", id: :integer, limit: 3, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.string "nom", limit: 50, default: "", null: false
  end

  create_table "bd_bd", primary_key: "bdid", id: :integer, limit: 3, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "bd_bdaid", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin" do |t|
  ...
  create_table "bd_membres", primary_key: "pid", id: :integer, limit: 3, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "bd_prets", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "bdid", null: false
  ...
  create_table "bd_series", primary_key: "sid", id: :integer, limit: 3, force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.string "nom", limit: 50, default: "", null: false
