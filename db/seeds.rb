...
user1 = User.create(name: "Stéphane", email:"stephane@vergeylen.eu", password:"dringg", :password_confirmation => 'dringg')
user2 = User.create(name: "JC", email:"jc@hotmail.com", password:"jc", :password_confirmation => 'jc')

c1 = Category.create(name: "Bandes dessinées", default_view: "list")
c2 = Category.create(name: "Films", default_view: "gallery")
